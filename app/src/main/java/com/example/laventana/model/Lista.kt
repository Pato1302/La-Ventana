...
object Lista {
    val lista = mutableListOf<Elemento>(
        ...
        Elemento("Café Jade",
            "Café Jade, Calle, Quinta Pte. Nte. 2, La Cañada, 29960 Palenque, Chis",
            R.drawable.cafejade,
            "+52 916 688 0051",
            17.50964002291641,
            -91.98688951637247,
        ...
        Elemento("Bambú Maya",
            ...
            17.493193847150113,
            -92.0208084623171,
            "Bambú Maya es un restaurante de comida mexicana, con un toque de comida internacional, ubicado en el corazón de Palenque, Chiapas.\\n\u200BOfrecemos una gran variedad de platillos, desde desayunos, comidas y cenas, hasta postres y bebidas.\\n\u200BContamos con un ambiente familiar, con un toque de elegancia y un servicio de calidad.\\n\u200B¡Visítanos!"),
        Elemento("Mundo Chiapas",
            "5ta. Av, Norte Poniente No. 451, Terán, 29050 Tuxtla Gutiérrez, Chis",
            R.drawable.mundochiapas,
            "+52 961 671 8355",
            16.7568891311304,
            -93.16937802503186,
            "Mundo Chiapas es un restaurante de comida mexicana, con un toque de comida internacional, ubicado en el corazón de Tuxtla Gutiérrez, Chiapas.\\n\u200BOfrecemos una gran variedad de platillos, desde desayunos, comidas y cenas, hasta postres y bebidas.\\n\u200BContamos con un ambiente familiar, con un toque de elegancia y un servicio de calidad.\\n\u200B¡Visítanos!"),
    )
}